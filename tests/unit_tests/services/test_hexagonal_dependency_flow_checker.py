...
class TestHexagonalDependencyFlowChecker(TestCase):
    ...
    def test_check_when_invoicing_project_is_wrong_should_return_errors(self):
        HexagonalProject(project_path='/usr/dev/project/invoicing/invoicing', layers=[
            HexagonalProjectLayer(index=1, name='ports', directories=['/domain/ports'], python_files=[
                PythonFile(
                ...
                PythonFile(
                    ...
                    project_folder_full_path='/usr/dev/project/invoicing/invoicing',
                    imported_modules=[])]),
            HexagonalProjectLayer(index=2, name='api', directories=['/host'], python_files=[
                PythonFile(
                ...
                PythonFile(
                    ...
                    project_folder_full_path='/usr/dev/project/invoicing/invoicing',
                    imported_modules=[])]),
            HexagonalProjectLayer(index=3, name='events', directories=['/domain/events'], python_files=[PythonFile(
                ...
                project_folder_full_path='/usr/dev/project/invoicing/invoicing',
                imported_modules=[])]),
            HexagonalProjectLayer(index=4, name='use_cases', directories=['/domain/usecases'], python_files=[PythonFile(
                ...
                relative_folder_path_from_project_folder='/domain/usecases',
                project_folder_full_path='/usr/dev/project/invoicing/invoicing',
                imported_modules=[])]), HexagonalProjectLayer(index=5, name='values', directories=['/domain/values'],
                                                              python_files=[PythonFile(
                                                                  ...
                                                                  project_folder_full_path='/usr/dev/project/invoicing/invoicing',
                                                                  imported_modules=[])]),
            HexagonalProjectLayer(index=6, name='adapters', directories=['/adapters'], python_files=[PythonFile(
                ...
                project_folder_full_path='/usr/dev/project/invoicing/invoicing',
                imported_modules=[])]),
            HexagonalProjectLayer(index=7, name='entities', directories=['/domain/entities'], python_files=[PythonFile(
