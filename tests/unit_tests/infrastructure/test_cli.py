...
from hexagonal.infrastructure.cli import run_check
...
class TestCli(TestCase):
    def test_cli_bootstrap_should_return_true(self):
        ...
        runner = CliRunner()
        result = runner.invoke(run_check, ['--source_path', get_project_path() + '/src/hexagonal'])
    ...
    def test_cli_run_check_should_return_no_errors_for_correct_project(self):
        # This tests check the consistency of this on project
        runner = CliRunner()
        result = runner.invoke(run_check, ['--source_path', get_sample_correct_test_project_path()])
    ...
    def test_cli_run_check_should_return_errors_for_wrong_project(self):
        # This tests check the consistency of this on project
        runner = CliRunner()
        result = runner.invoke(run_check, ['--source_path', get_sample_wrong_test_project_path()])
